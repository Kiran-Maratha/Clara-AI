...
def analyze_request(prompt, media=None, issue_context="General IT Support"):
    """
    ...
    understanding_model = 'gemini-3.1-flash-lite'
    ...
    contents = [f"ISSUE CATEGORY: {issue_context}\nUSER INPUT:", prompt]
